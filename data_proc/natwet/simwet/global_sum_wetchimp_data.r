...
# stocker14gmd <- './data/nat_wetland_map/f_peat_dyptop_stocker14gmd.nc'
# 


#h <- '../../data/lucc/hyde32_beta/zip/hyde32.nc'
stocker14gmd <- nc_open(stocker14gmd)

# read zhang's layers as rasters
s <- raster(stocker14gmd, varname="f_peat")
...
wetchimp_list <- c(wet_orchidee_exp1)
