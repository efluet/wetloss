...
dir <- './output/results/wetloss/sum/'
wetloss_all_0.5 <- read.csv(paste0(dir, 'global_sum_wetloss_wetchimp_0.5_3subgrid.csv'))
wetloss_all_1.0 <- read.csv(paste0(dir, 'global_sum_wetloss_wetchimp_3subgrid.csv'))
wetloss_all_2.5 <- read.csv(paste0(dir, 'global_sum_wetloss_2.5_3subgrid.csv'))

# fill column of resolution
wetloss_all_0.5$res <- 0.5
wetloss_all_1.0$res <- 1.0
wetloss_all_2.5$res <- 2.5

# combine into one df
wetloss_all <- bind_rows(wetloss_all_0.5, wetloss_all_1.0, wetloss_all_2.5)

# remove temps
rm(wetloss_all_0.5, wetloss_all_1.0, wetloss_all_2.5)
...
wetloss_all<- wetloss_all %>%
  ...
  # remove years not ending in 0 ( to remove 2001-2009)
  filter(year %% 10 ==0) %>%
...
# write outputs 
write.csv(wetloss_all,          "./output/results/wetloss/sum/wetloss_all_area.csv")
write.csv(wetloss_ensemble_prc, "./output/results/wetloss/sum/wetloss_ensemble_prc.csv")
